...
const reviews = [
    {
        ...
        profit: 4891,
        description:
            "The AI Arbitrage method is incredible!. My account manager always there to me every step of the wayThe AI Arbitrage method... <a href='#thanksForm' class='text_green fw-medium'>Show More</a>",
    ...
    },
    {
         ...
         profit: 5207,
         description:
             "AI Arbitrage has made my trading experience so much better. The support  manager was exceptional. Great profits in no time!",
     ...
     },
  {
 ...
 },
    {
        ...
        profit: 8126,
        description:
            "AI Arbitrage made trading so simple and profitable. My  was always ready to help and provide valuable insights. Highly recommend it!",
...
function generateReviewCard(review) {
    ...
    <div class="slider_green_box bg-white slider_card">
        <div class="d-flex flex-row flex_xsm_col align-items-start  justify-content-between mt-35">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="ms-1">
                    ...
                    <div class="mt-sm-0 review_slider_parent">
                        <p class="mb-0 opacity_07 leading_150 fw-bold fs_base text-nowrap text-white">Invested <span class="text-white text-nowrap fw_800">${review.invested.toLocaleString()} CAD</span></p>
                        <p class="mb-0 opacity_07 leading_150 fw-bold fs_base text-nowrap text-white">Profit: <span class="text-white text-nowrap fw_800">${review.profit.toLocaleString()} CAD</span></p>
                    </div>
           </div>
        <p class="leading_150 fs_base text-white opacity_07 pt-sm-4 mt-sm-1 mt-3 mb-0"><span class="fw-bold">Review</span> ${review.description
        }</p></div>
    </div>
`;
}
